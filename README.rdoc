...
The Rails router that recognizes URL and dispatches them to the node and resource controllers' actions, dealing with HTTP requests of GET and POST is located at /config/routes.rb. It can also generate paths and URLs, avoiding the need to hardcode strings in our views.
