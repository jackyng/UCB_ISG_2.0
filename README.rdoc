Deployment URL: http://www.isg2.herokuapp.com 
...
Backend:
1. /app/controllers/node_controller.rb - contains all the functions that interacts between the tree structure in our model and the view. index contains all the instance variables for the index/root view. create and destroy let the users and us add and remove nodes from the tree structure/model. add_child helps add a child to the parent we want in the tree.
